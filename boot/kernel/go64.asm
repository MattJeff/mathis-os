...
; draw_windows moved to ui/window.asm

; draw_terminal_window moved to ui/window.asm
...
; draw_start_menu moved to ui/desktop.asm

; draw_proc_indicator and draw_clock moved to ui/taskbar.asm

; ════════════════════════════════════════════════════════════════════════════
; DRAW MOUSE CURSOR (Arrow shape)
; ════════════════════════════════════════════════════════════════════════════
; draw_mouse_cursor moved to ui/desktop.asm

; draw_icon_terminal, draw_icon_folder, draw_icon_cube moved to ui/desktop.asm
...
; setup_idt64, setup_tss64, setup_pic64, setup_pit64 moved to sys/setup.asm
